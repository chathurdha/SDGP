...
const ReceivedSeminarRequests = () => {
  ...
  const schools = [
      { _id: 1, name: "School 1 computers science software engineeringSchool 1 computers science software engineeringSchool 1 computers science software engineering", address: "address 1", profileColor: "bg-red-400", profileImageAvailable: true},

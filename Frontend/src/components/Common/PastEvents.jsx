...
const PastEvents = () => {
    ...
    const uniqueYears = new Set(seminars.map((seminar) => extractYear(seminar.expDate)));
          ...
          const matchingPairs = seminars.filter(
              (seminar) => {
                console.log(selectedYear.value);
                  ...
                  return(
                    extractYear(seminar.expDate) === selectedYear.value
                  );
              }
          );
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex justify-center">
                <div className="pt-4 pb-12 md:w-2/3 lg:w-1/2 text-center">
                    <p>
                        We believe that we can act a major role in the journey of creating a better society. During the journey we had gone through so many milestones. We believe this investment will impact the future of this country.
                    </p>
                </div>
            </div>

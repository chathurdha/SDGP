...
import Footerbg3 from "/src/assets/footerbg3.svg";
      ...
      <div className="container mx-auto px-4 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-10">
          ...
          <div className="col-span-1">
            <img src={FullLogo} alt="Logo" className="h-10 w-17 mb-4" />
            <p className="text-sm">
              To bring quality education experience to every school in Sri
              Lanka. <br></br>Join hands to make a better future for our
              children.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="flex items-center">
              ...
              <p className="ml-2"> sisusaviya.sdgp@gmail.com </p>
            </div>
            ...
            <a
              href="https://www.instagram.com/sisusaviya/"

...
import SchoolNav from "./components/School/SchoolNav.jsx";
import ReviewBackground from "./pages/School/ReviewBackground.jsx";
import SendReviewBackground from "./pages/School/SendReviewBackground.jsx";
    ...
    return (
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route path="/send-reviews" element={<SendReviewBackground/>} />
            </Routes>
        </BrowserRouter>
    );
}
